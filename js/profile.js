                    ...
                    return `
                        <div style="background:rgba(15,23,42,0.9);padding:15px;margin:12px 0;border-radius:14px;display:flex;align-items:center;gap:15px;flex-wrap:wrap;">
                            ...
                            <div style="display:flex;gap:8px;flex-wrap:wrap;">
                                ${items.map(id => id ? `<img src="https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/items/${id}.png" style="width:52px;height:38px;border-radius:6px;" onerror="this.style.display='none'">` : `<div style="width:52px;height:38px;background:#333;border:1px dashed #555;"></div>`).join("")}
